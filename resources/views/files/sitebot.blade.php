    ...
    <div>
        ...
        <div class="bg-white">
            <div class="container-lg py-16">
                ...
                <h3 class="text-black text-center text-lg mt-8">
        ...
        <footer class="text-center bg-black py-16">
            <div class="flex flex-col items-center">
                <button class="btn-nav-orange text-2xl">Get started for free</button>
            </div>
            ...
            <div class="container-lg py-16">
                <div class="md:flex md:flex-row -mx-2">
                    ...
                    <div class="flex justify-center flex-col flex-1 m-4 text-lg">
                        <div class="mb-4"><a class="text-white" href="/blog">Blog</a></div>
                        <div class="mb-4"><a class="text-white" href="/contact">Contact</a></div>
                        <div class="mb-4"><a class="text-white" href="https://twitter.com/sitebotai">Twitter</a></div>
                    </div>
                </div>
